 ...
 */
class Food_Restro_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Food_Restro_Dropdown_Category_Control extends WP_Customize_Control {
...
class Food_Restro_Note_Control extends WP_Customize_Control {
...
class Food_Restro_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Food_Restro_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="food-restro-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Food_Restro_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Food_Restro_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="food-restro-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'food-restro' ); ?>" class="food-restro-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Food_Restro_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
